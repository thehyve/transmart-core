...
<g:form name="createAnalysisForm">
    ...
    <table class="detail" height="300px">
        <tbody>
            ...
            <g:render template="metaData" model="[templateType: templateType,
                                                                             measurements:measurements, technologies:technologies, vendors:vendors, platforms:platforms, title:title, bioDataObject:bioDataObject, folder:folder, amTagTemplate: amTagTemplate, metaDataTagItems: metaDataTagItems]"/>
        </tbody>
    </table>
