...
class ClinicalDataRetrievalTests {
    ...
    TestData createTestData() {
        ...
        new TestData(concept: conceptData, i2b2: i2b2Data, clinical: clinicalData)
    }
    ...
    private String getConceptCodeFor(String conceptPath) {
        testData.concept.conceptDimensions.find {
    ...
    void testColumnsLabel() {
        results = clinicalDataResourceService.retrieveData(testData.clinical.queryResult,
    ...
    void testMultipleQueryResultsVariant() {
        results = clinicalDataResourceService.retrieveData(
                testData.i2b2.patients[0..1].collect {
        ...
        assertThat rows, hasItem(allOf(
                ...
                hasProperty('patient',
                        hasSameInterfaceProperties(Patient,
                                testData.i2b2.patients[2] /* -103 */, ['assays'])),
    ...
    void testColumnsAndDataAreInTheSpecifiedOrder() {
        def conceptVariables =  [
                ...
                new TerminalConceptVariable(conceptCode: 'c2') ]
        results = clinicalDataResourceService.retrieveData(
                testData.clinical.queryResult, conceptVariables)

        def expectedOrder = [ 'd1', 'c2' ]

        def createMatcher = { ->
            contains(
                    testData.clinical.facts.sort { ObservationFact fact1,
    ...
    void testRepeatedDataPoint() {
        ClinicalTestData.createObservationFact(
                testData.concept.conceptDimensions.find { it.conceptCode == 'c2' },
                testData.i2b2.patients[1],
                -20000,
    ...
    void testInexistentConcept() {
        ...
        assertThat shouldFail(InvalidArgumentsException, {
            clinicalDataResourceService.retrieveData(testData.clinical.queryResult,
