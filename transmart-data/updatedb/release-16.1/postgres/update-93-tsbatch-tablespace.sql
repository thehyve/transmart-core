...
GRANT ALL ON TABLE batch_job_execution TO ts_batch;
GRANT ALL ON TABLE batch_job_execution_context TO tm_cz;
GRANT ALL ON TABLE batch_job_execution_context TO ts_batch;
GRANT ALL ON TABLE batch_job_execution_params TO tm_cz;
GRANT ALL ON TABLE batch_job_execution_params TO ts_batch;
GRANT ALL ON TABLE batch_job_instance TO tm_cz;
GRANT ALL ON TABLE batch_job_instance TO ts_batch;
GRANT ALL ON TABLE batch_step_execution TO tm_cz;
GRANT ALL ON TABLE batch_step_execution TO ts_batch;
GRANT ALL ON TABLE batch_step_execution_context TO tm_cz;
GRANT ALL ON TABLE batch_step_execution_context TO ts_batch;
--GRANT ALL ON INDEX batch_step_execution_context_pkey TO tm_cz;
--GRANT ALL ON INDEX batch_step_execution_context_pkey TO ts_batch;
--GRANT ALL ON INDEX job_inst_un TO tm_cz;
--GRANT ALL ON INDEX job_inst_un TO ts_batch;

GRANT ALL ON SEQUENCE batch_job_execution_seq TO tm_cz;
GRANT ALL ON SEQUENCE batch_job_execution_seq TO ts_batch;
GRANT ALL ON SEQUENCE batch_job_seq TO tm_cz;
GRANT ALL ON SEQUENCE batch_job_seq TO ts_batch;
GRANT ALL ON SEQUENCE batch_step_execution_seq TO tm_cz;
GRANT ALL ON SEQUENCE batch_step_execution_seq TO ts_batch;
