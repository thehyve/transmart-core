...
--
CREATE OR REPLACE FUNCTION tm_cz.i2b2_load_study_metadata(currentjobid numeric DEFAULT (-1)) RETURNS bigint
...
ALTER FUNCTION tm_cz.i2b2_load_study_metadata(numeric)
    OWNER TO tm_cz;

GRANT EXECUTE ON FUNCTION tm_cz.i2b2_load_study_metadata(numeric) TO tm_cz;