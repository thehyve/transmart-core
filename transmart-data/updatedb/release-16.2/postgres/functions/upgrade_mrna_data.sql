...
--
CREATE OR REPLACE FUNCTION tm_cz.upgrade_mrna_data(currentjobid bigint DEFAULT NULL::bigint) RETURNS void
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
ALTER FUNCTION tm_cz.upgrade_mrna_data(bigint)
    OWNER TO tm_cz;

GRANT EXECUTE ON FUNCTION tm_cz.upgrade_mrna_data(bigint) TO tm_cz;