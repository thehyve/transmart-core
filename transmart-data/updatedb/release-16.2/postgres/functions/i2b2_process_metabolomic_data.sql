...
ALTER FUNCTION tm_cz.i2b2_process_metabolomic_data(character varying, character varying, character varying, character varying, bigint, character varying, bigint)
    OWNER TO tm_cz;

GRANT EXECUTE ON FUNCTION tm_cz.i2b2_process_metabolomic_data(character varying, character varying, character varying, character varying, bigint, character varying, bigint) TO tm_cz;