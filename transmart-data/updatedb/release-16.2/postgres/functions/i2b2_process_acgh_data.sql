...
--
CREATE OR REPLACE FUNCTION tm_cz.i2b2_process_acgh_data(trial_id character varying, top_node character varying, source_cd character varying DEFAULT 'STD'::character varying, secure_study character varying DEFAULT 'N'::character varying, currentjobid numeric DEFAULT (-1)) RETURNS numeric
...
ALTER FUNCTION tm_cz.i2b2_process_acgh_data(character varying, character varying, character varying, character varying, numeric)
    OWNER TO tm_cz;

GRANT EXECUTE ON FUNCTION tm_cz.i2b2_process_acgh_data(character varying, character varying, character varying, character varying, numeric) TO tm_cz;