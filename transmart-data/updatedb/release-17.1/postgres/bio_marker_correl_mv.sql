...
UNION
 SELECT DISTINCT c1.bio_data_id AS bio_marker_id,
    ...
    8 AS mv_id
   FROM (((biomart.bio_data_correlation c1
     JOIN biomart.bio_data_correlation c2 ON ((c1.asso_bio_data_id = c2.bio_data_id)))
     JOIN biomart.bio_data_correl_descr d1 ON ((c1.bio_data_correl_descr_id = d1.bio_data_correl_descr_id)))
     JOIN biomart.bio_data_correl_descr d2 ON ((c2.bio_data_correl_descr_id = d2.bio_data_correl_descr_id)))
...
GRANT SELECT ON TABLE biomart.bio_marker_correl_mv TO biomart_user;
GRANT ALL ON TABLE biomart.bio_marker_correl_mv TO biomart;
