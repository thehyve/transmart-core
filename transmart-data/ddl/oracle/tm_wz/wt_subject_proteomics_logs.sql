--
-- Type: TABLE; Owner: TM_WZ; Name: WT_SUBJECT_PROTEOMICS_LOGS
--
...
--
-- Type: INDEX; Owner: TM_WZ; Name: WT_SUBJECT_PROTEOMICS_LOGS_I1
--
CREATE INDEX "TM_WZ"."WT_SUBJECT_PROTEOMICS_LOGS_I1" ON "TM_WZ"."WT_SUBJECT_PROTEOMICS_LOGS" ("TRIAL_NAME", "PROBESET_ID")
TABLESPACE "INDX" ;
