...
--
-- Type: REF_CONSTRAINT; Owner: I2B2DEMODATA; Name: ENCOUNTER_MAPPING_ENCOUNTER_NUM_FK
--
ALTER TABLE "I2B2DEMODATA"."ENCOUNTER_MAPPING" ADD CONSTRAINT "ENCOUNTER_MAPPING_ENCOUNTER_NUM_FK" FOREIGN KEY ("ENCOUNTER_NUM")
 REFERENCES "I2B2DEMODATA"."VISIT_DIMENSION" ("ENCOUNTER_NUM") ENABLE;
