...
--
ALTER TABLE linked_file_collection ADD CONSTRAINT "SOURCE_SYSTEM_ID_ID_FK" FOREIGN KEY (source_system_id)
 REFERENCES storage_system (id);
--
-- Name: STUDY_ID_FK; Type: CONSTRAINT; Schema: i2b2demodata; Owner: -
--
ALTER TABLE linked_file_collection ADD CONSTRAINT "STUDY_ID_FK" FOREIGN KEY (study)
