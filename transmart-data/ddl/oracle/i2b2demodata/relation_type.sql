...
--
  CREATE OR REPLACE TRIGGER "I2B2DEMODATA"."TRG_RELATION_TYPE_ID"
	 before insert on "I2B2DEMODATA"."RELATION_TYPE"
	 for each row begin
	 if inserting then
...
GRANT SELECT ON "I2B2DEMODATA"."RELATION_TYPE" TO "BIOMART_USER";
GRANT ALL ON "I2B2DEMODATA"."RELATION_TYPE" TO "I2B2DEMODATA";
GRANT ALL ON "I2B2DEMODATA"."RELATION_TYPE" TO "TM_CZ";
