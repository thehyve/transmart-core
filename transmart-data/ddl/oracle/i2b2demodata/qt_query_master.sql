...
--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: QT_QUERY_MASTER_REQUEST_CONSTRAINT_IDX
--
CREATE INDEX "I2B2DEMODATA"."QT_QUERY_MASTER_REQUEST_CONSTRAINT_IDX" ON "I2B2DEMODATA"."QT_QUERY_MASTER" ("REQUEST_CONSTRAINTS")
TABLESPACE "TRANSMART" ;

--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: QT_QUERY_MASTER
--
