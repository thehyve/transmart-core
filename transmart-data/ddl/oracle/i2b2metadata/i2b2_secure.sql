...
ADD CONSTRAINT "I2B2_SECURE_PK_FULLNAME" PRIMARY KEY ("C_FULLNAME") USING INDEX TABLESPACE "INDX" ENABLE;

--
-- Type: INDEX; Owner: I2B2METADATA; Name: IDX_I2B2_SEC_LEVEL_FULLNAME
--
CREATE INDEX "I2B2METADATA"."IDX_I2B2_SEC_LEVEL_FULLNAME" ON "I2B2METADATA"."I2B2_SECURE" ("C_HLEVEL", "C_FULLNAME")
TABLESPACE "INDX" ;
