--
-- Type: PROCEDURE; Owner: TM_CZ; Name: I2B2_MRNA_INC_SUB_ZSCORE
--
  CREATE OR REPLACE PROCEDURE "TM_CZ"."I2B2_MRNA_INC_SUB_ZSCORE" 
( trial_id IN VARCHAR
 ,currentJobID 	NUMBER := null
  ...
  TrialID		varchar2(100);
   ...
   FROM de_subject_microarray_data d
...
BEGIN
	...
	TrialID := upper(trial_id);
     ...
     --If Job ID does not exist, then this is a single procedure run and we need to create it
        ...
        stepCt := 0;
	stepCt := stepCt + 1;
	cz_write_audit(jobId,databaseName,procedureName,'Starting I2B2_MRNA_INC_SUB_ZSCORE',0,stepCt,'Done');
        
        -- call the cursor and update the z-score value for incmental data;
        for UpdateZscore in zscore_params
           loop
 
               update de_subject_microarray_data d 
	...
	cz_write_audit(jobId,databaseName,procedureName,'update zscore calc for this trial',0,stepCt,'Done');
        ...
        --Normalize the  zscore value when greater than 2.5 and lesser than -2.5
            ...
            update de_subject_microarray_data 
	  ...
	  cz_write_audit(jobId,databaseName,procedureName,'Normalize the zscore calc value',0,stepCt,'Done');
          ...
          stepCt := stepCt + 1;
	  cz_write_audit(jobId,databaseName,procedureName,'END of I2B2_MRNA_INC_SUB_ZSCORE',0,stepCt,'Done');
          commit; 
                                        
   


END I2B2_MRNA_INC_SUB_ZSCORE;
/
