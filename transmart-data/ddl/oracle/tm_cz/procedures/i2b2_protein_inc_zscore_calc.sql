--
-- Type: PROCEDURE; Owner: TM_CZ; Name: I2B2_PROTEIN_INC_ZSCORE_CALC
--
  CREATE OR REPLACE PROCEDURE "TM_CZ"."I2B2_PROTEIN_INC_ZSCORE_CALC" 
(
  trial_id VARCHAR2
 ,run_type varchar2 := 'L'
...
*/	
        ...
        commit;
        stepCt := stepCt + 1;
	cz_write_audit(jobId,databaseName,procedureName,'Delete for trial in deapp.DE_SUBJECT_PROTEIN_DATA',SQL%ROWCOUNT,stepCt,'Done');
