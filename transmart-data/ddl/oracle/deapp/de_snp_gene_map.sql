...
TABLESPACE "INDX" ;
--
-- Type: INDEX; Owner: DEAPP; Name: IDX_DE_SNP_GENE_MAP_GENEN
--
CREATE INDEX "DEAPP"."IDX_DE_SNP_GENE_MAP_GENEN" ON "DEAPP"."DE_SNP_GENE_MAP" ("GENE_NAME")
TABLESPACE "TRANSMART" ;
--
-- Type: INDEX; Owner: DEAPP; Name: SNP_GENE_MAP_IDX
--
CREATE INDEX "DEAPP"."SNP_GENE_MAP_IDX" ON "DEAPP"."DE_SNP_GENE_MAP" ("ENTREZ_GENE_ID", "SNP_NAME")
TABLESPACE "INDX" ;
