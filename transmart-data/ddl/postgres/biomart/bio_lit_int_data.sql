...
--
-- Name: bio_lit_int_data bio_lit_int_data_pk; Type: CONSTRAINT; Schema: biomart; Owner: -
--
...
--
-- Name: bio_lit_int_data trg_bio_lit_int_data_id; Type: TRIGGER; Schema: biomart; Owner: -
--
...
--
-- Name: bio_lit_int_data bio_lit_int_ref_fk; Type: FK CONSTRAINT; Schema: biomart; Owner: -
--
ALTER TABLE ONLY bio_lit_int_data
