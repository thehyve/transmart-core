...
--
-- Name: bio_assay_sample bio_assay_sample_pk; Type: CONSTRAINT; Schema: biomart; Owner: -
--
...
--
-- Name: bio_assay_sample bio_assay_sample_bio_assay_fk; Type: FK CONSTRAINT; Schema: biomart; Owner: -
--
ALTER TABLE ONLY bio_assay_sample
    ADD CONSTRAINT bio_assay_sample_bio_assay_fk FOREIGN KEY (bio_assay_id) REFERENCES bio_assay(bio_assay_id);

--
-- Name: bio_assay_sample bio_assay_sample_bio_sample_fk; Type: FK CONSTRAINT; Schema: biomart; Owner: -
--
ALTER TABLE ONLY bio_assay_sample
