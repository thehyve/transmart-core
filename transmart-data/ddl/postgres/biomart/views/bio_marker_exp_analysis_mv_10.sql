--
-- Name: bio_marker_exp_analysis_mv_10; Type: VIEW; Schema: biomart; Owner: -
--
CREATE VIEW bio_marker_exp_analysis_mv_10 AS
 SELECT DISTINCT t3.bio_marker_id,
    t1.bio_experiment_id,
    t1.bio_assay_analysis_id,
    ((t1.bio_assay_analysis_id * 100) + t3.bio_marker_id) AS "T1.BIO_ASSAY_ANALYSIS_ID*100"
