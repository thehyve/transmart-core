...
--
-- Name: de_metabolite_sub_pathways de_metabolite_sub_pathway_pk; Type: CONSTRAINT; Schema: deapp; Owner: -
--
ALTER TABLE ONLY de_metabolite_sub_pathways
    ADD CONSTRAINT de_metabolite_sub_pathway_pk PRIMARY KEY (id);

--
-- Name: de_metabolite_sub_pathways de_met_sub_pw_sup_pw_id_fkey; Type: FK CONSTRAINT; Schema: deapp; Owner: -
--
ALTER TABLE ONLY de_metabolite_sub_pathways
