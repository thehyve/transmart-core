...
COMMENT ON COLUMN i2b2.c_basecode IS 'code that represents node. E.g. VSIGN:HR';
COMMENT ON COLUMN i2b2.c_visualattributes IS 'Visualattributes describes how a ui should show this node';