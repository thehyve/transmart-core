...
--
CREATE SEQUENCE i2b2metadata.i2b2_tag_types_tag_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
ALTER TABLE ONLY i2b2metadata.i2b2_tag_types ALTER COLUMN tag_type_id
    SET DEFAULT nextval('i2b2_tag_types_tag_type_id_seq'::regclass);

--
-- Name: i2b2_tag_types_node_type_tag_type_unique; Type: CONSTRAINT; Schema: i2b2metadata; Owner: -
--
ALTER TABLE ONLY i2b2metadata.i2b2_tag_types
...
--
CREATE UNIQUE INDEX idx_i2b2_tag_type_pk ON i2b2metadata.i2b2_tag_types USING btree (tag_type_id);
