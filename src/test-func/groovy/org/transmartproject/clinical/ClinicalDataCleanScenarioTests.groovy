package org.transmartproject.clinical
...
import org.transmartproject.beans.GenericFunctionalTestConfiguration
import org.transmartproject.concept.ConceptFullName
        ...
        assertThat r, everyItem(
                new BaseMatcher<Map>() {
                    boolean matches(Object item) {
                        new ConceptFullName(item.concept_path)[-1] ==
                                item.tval_char
                    }
