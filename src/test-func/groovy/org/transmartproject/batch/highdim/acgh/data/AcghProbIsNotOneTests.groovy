...
class AcghProbIsNotOneTests implements FileCorruptingTestTrait {

    private final static String STUDY_ID = 'CLUC'
    private final static String PLATFORM_ID = 'ACGH_ANNOT'

    File originalFile = new File("studies/${STUDY_ID}/acgh/acgh_data.tsv")
    ...
    void testFailOnIncorrectProbability() {
        ...
        def runJob = RunJob.createInstance('-p', "studies/${STUDY_ID}/acgh.params",
