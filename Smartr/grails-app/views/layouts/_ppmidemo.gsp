    ...
    <div id="sr-ppmi-variantdb-form">
        ...
        <div id="sr-ppmi-maf-form">
            ...
            <div>
                ...
                <input id="sr-ppmi-global-maf" type="number" min="0.1" max="1" step="0.05" ng-model="variantDB.smartr.misc.globalMAF" style="width: 40px;"/>
            </div>
            <div>
                <label for="sr-ppmi-cohort-maf">Group AF (greater than)</label>
                <input id="sr-ppmi-cohort-maf" type="number" min="0" max="1" step="0.05" ng-model="variantDB.smartr.misc.cohortMAF" style="width: 40px;"/>
            </div>
        </div>
    </div>
