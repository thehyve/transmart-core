...
import static org.transmartproject.rest.test.StubStudyLoadingService.createStudyAccess

@WithGMock
@TestMixin(IntegrationTestMixin)
class StudyAccessMarshallerTests {
    ...
    private static final Map ACCESSIBILITY = [ accessView : true,
                                               accessExport : true ]

    StudyAccess getMockStudyAccess() {
        createStudyAccess(STUDY_ID, ONTOLOGY_KEY, ACCESSIBILITY)
    }
    ...
    void basicTest() {
        ...
        assertThat slurper.parseText(json.toString()), allOf(
                ...
                hasEntry('accessibility', ACCESSIBILITY)
                    )
