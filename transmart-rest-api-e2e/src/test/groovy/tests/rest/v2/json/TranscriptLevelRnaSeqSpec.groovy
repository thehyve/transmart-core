...
class TranscriptLevelRnaSeqSpec extends RESTSpec {
    ...
    def "transcripts content check"() {
        ...
        (0..<selector.cellCount).each {
            ...
            assert [-641I, -642I, -643I, -644I, -645I, -646I, -647I, -648I, -649I].contains(selector.select(it, 'assay', 'assay', 'Int'))
            ...
            assert ['Male', 'Female'].contains(selector.select(it, 'patient', 'sexCd', 'String'))
