			...
			<div id="plotCurveDesc">
				<table id="newspaper-a">
					...
					<tfoot>
						<tr>
							<td colspan="5">
								<em>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec aliquam faucibus tortor, eget consequat
								...
								mattis. Fusce eu libero mauris. Aliquam consequat tincidunt arcu. Integer vel congue odio.</em>
							</td>
						</tr>
					</tfoot>
					<tbody>
