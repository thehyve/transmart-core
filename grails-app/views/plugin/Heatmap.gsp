	...
	<form>
		...
		<table class="subsettable" style="margin: 10px;width:300px; border: 0px none; border-collapse: collapse;" >
			<tr>
				...
				<img src="${resource(dir:'images', file:'help/helpicon_white.jpg')}" alt="Help" border=0 width=18pt style="margin-top:1pt;margin-bottom:1pt;margin-right:18pt;float:right"/>
					</a>						
				</td>			
			</tr>	
			<tr>
			...
			<tr>
				<td colspan="4" align="center">
					<input type="button" value="Run" onClick="submitHeatmapJob(this.form);">
				</td>
			</tr>
		</table>
	</form>
