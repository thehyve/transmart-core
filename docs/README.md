# tranSMART 17.2.6 Installation

Below are the installation instructions for tranSMART version 17.2.6. If you already have an older version of tranSMART, follow the [upgrade guide](upgrade.md) instead.
