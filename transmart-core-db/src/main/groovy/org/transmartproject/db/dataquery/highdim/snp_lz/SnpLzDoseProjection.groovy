...
/**
 * Returns only the dose of the minor allele.
 * *
 */
@CompileStatic
class SnpLzDoseProjection implements CriteriaProjection<Double> {

    private static final String DOMAIN_CLASS_PROPERTY = 'doseByProbeBlob'
