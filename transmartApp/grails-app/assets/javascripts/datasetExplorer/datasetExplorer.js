        ...
        queryPanel = new Ext.Panel(
            {
                ...
                split: true,
                autoLoad: {
                    url : pageInfo.basePath+'/assets/panels/subsetPanel.html',
                    scripts: true,
                    nocache: true,
                    discardUrl: true,
                    method: 'POST'
...
function printPreview(content) {
    var stylesheet = "<html><head><link rel='stylesheet' type='text/css' href='" + pageInfo.basePath + "/css/chartservlet.css'></head><body>";
