...
[transmart-copy-17.2-SNAPSHOT.jar](https://repo.thehyve.nl/service/local/repositories/snapshots/content/org/transmartproject/transmart-copy/17.2-SNAPSHOT/transmart-copy-17.2-SNAPSHOT.jar).

```bash
# Download transmart-copy
curl -f -L https://repo.thehyve.nl/service/local/repositories/snapshots/content/org/transmartproject/transmart-copy/17.2-SNAPSHOT/transmart-copy-17.2-SNAPSHOT.jar -o transmart-copy.jar
```
