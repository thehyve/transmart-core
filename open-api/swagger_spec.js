var spec = {
  ...
  "paths": {
    ...
    "/v2/observations": {
      ...
      "post": {
        "description": "Gets all observations that satisfy the given constaint. Only observations the calling user has access to are returned. Empty and null values are returned but have no value property. Supports passing longer constraints than for the GET method.\n",
        "tags": [
          "v2"
        ],
        "produces": [
    ...
    "/v2/observations/aggregate": {
      ...
      "post": {
        "description": "Calculates and returns an aggregate value. Supports passing longer constraints than for the GET method.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
    ...
    "/v2/observations/count": {
      ...
      "post": {
        "description": "Counts the number of observations that satisfy the given constraint. Supports passing longer constraints than for the GET method.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
    ...
    "/v2/patients": {
      ...
      "post": {
        "description": "Gets all patients that have an observation that satisfy the given constaint. Only patients the calling user has access to are returned. Supports passing longer constraints than for the GET method.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
