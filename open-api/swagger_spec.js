var spec = {
  ...
  "paths": {
    ...
    "/v2/studies/studyIds": {
      "get": {
        "description": "Gets the studies with study ids `studyIds`.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
    ...
    "/v2/observations/table": {
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "query",
            "type": "string",
            "description": "JSON-encoded constraint specification. Example: `{\"type\":\"concept\",\"path\":\"\\\\Public Studies\\\\EHR\\\\Vital\nSigns\\\\Heart Rate\\\\\"}`.\n"
          },
          {
            "name": "rowDimensions",
            "required": true,
            "in": "query",
            "type": "string",
            "description": "Json list of strings, with each string being a dimension name. This specifies the dimensions\nthat form the vertical axis of the table (in order). Example: `['study', 'patient']`\n"
          },
          {
            ...
            "in": "query",
            "type": "string",
            "description": "The same as `columnDimensions`, but with the dimensions that specify the horizontal axis of the table"
          },
          {
            "name": "rowSort",
            "required": false,
            "in": "query",
            "type": "string",
            "description": "Json list of sort specifications for the row dimensions. A sort specification is either the name of a\ndimension as string, or a list `[<dimension>, <direction>]` where `<dimension>` is the name of a\ndimension and `<direction>` is either `'asc'` or `'desc'`. The dimension must be a dimension that is\npart of the `rowDimensions` parameter. This defaults to the order specified in `rowDimensions`.\nExample: `['study', ['patient', 'desc']]`\n"
          },
          {
            "name": "columnSort",
            "required": false,
      ...
      "post": {
        "description": "The same as the `get` call, but with parameters specified as a JSON object in the request body. Useful if the\nparameters don't fit in a single request. \n\nSee the `get` version for additional documentation.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
    ...
    "DataTable": {
      ...
      "schema": {
        ...
        "properties": {
                  ...
                  "items": {
                    ...
                    "properties": {
                      ...
                      "key": {
                        ...
                        "description": "Analogous to `column_headers*.keys`. The value is a reference to a dimension element\nspecified in `row_dimensions*.elements` for the specified dimension.\n\nThis property is mutually exclusive with the `element` property.\n"
                      },
                      "element": {
                        "type": {
                          "oneOf": [
          ...
          "column_dimensions": {
            "description": "The same as `row_dimensions`, but for the column dimensions.\n",
            "type": "array",
            "items": {
              "type": "object",
              "properties": {
