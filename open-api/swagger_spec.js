var spec = {
  ...
  "paths": {
        ...
        "parameters": [
          {
            ...
            "required": false,
            "in": "query",
            "description": "Name of the export job (has to be unique). If it is not specified, a default name will be created.",
            "type": "string"
          }
        ],
        "responses": {
    ...
    "/v2/export/{jobName}/run": {
      "get": {
        "description": "Runs the specified data export job asynchronously. Creates a hypercube for each element from {elements} with PatientSetsConstraint for given {ids}\nand serialises it to specified (fileFormat}. Output stream is saved as .zip file in `tempFolderDirectory`, specified in configuration file.\n",
        "tags": [
          "v2"
        ],
        "parameters": [
          {
            ...
            "required": true,
            "in": "path",
            "description": "name of the export job. The job has to have a status `Started`",
            "type": "string"
          },
          {
            "name": "setType",
          ...
          },
          {
            ...
            "required": true,
            "in": "query",
            "description": "list of json objects: {data_type, format} pairs.",
            "type": "array",
            "items": {
              "type": "object",
              "properties": {
                "dataType": {
                  "type": "string",
                  "description": "type of the data you want to retrieve, either `clinical` for clinical data, or one of the supported high dimensional data types."
                },
                "format": {
                  "type": "string",
                  "description": "one of the supported file formats you want to export current data type to, e.g. `TSV`"
                }
              }
            }
          }
        ...
        "responses": {
          "200": {
            "description": "Returns the first time at which the `Trigger` to run the export will be fired by the scheduler.\n",
            "type": "object",
            "properties": {
              "jobName": {
                "type": "string"
        ...
        "parameters": [
          {
            ...
            "required": true,
            "in": "path",
            "description": "name of the export job. The job has to have a status `Completed`",
            "type": "string"
          }
        ],
        "responses": {
    ...
    "/v2/export/{jobName}/status": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Return the result as a json object. Example: `{status: STARTED}`.",
            "schema": {
              "type": "object",
              "properties": {
                "status": {
    ...
    "/v2/export/supported_file_formats": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Returns a list of file formats that data can be exported to.\n",
            "schema": {
              "type": "object",
              "properties": {
