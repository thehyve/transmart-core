var spec = {
    ...
    "paths": {
        ...
        "/v2/supported_fields": {
            "get": {
                "description": "Gets all supported `fields`. These are the fields that can be used in constraints.\n",
                "tags": [
                    "v2"
                ],
                "responses": {
        ...
        "/v2/observations/count": {
            "get": {
                "description": "counts the number of observations there are for the given constraint.\n",
                "tags": [
                    "v2"
                ],
                "parameters": [
                ...
                "responses": {
                    "200": {
                        "description": "return the result in a json object Example: {count:56}",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "count": {
        ...
        "/v2/observation_list": {
            "get": {
                "description": "Gets all `observations` that evaluate to true for the given constaint in list form.\n",
                "tags": [
                    "v2"
                ],
                "parameters": [
                ...
                "responses": {
                    "200": {
                        "description": "return a list with observation objects",
                        "schema": {
                            "type": "array",
                            "items": {
        ...
        "/v2/studies/{studyId}/files": {
            "get": {
                "description": "Gets a list of all `file_links` related to a study\n",
                "tags": [
                    "v2"
                ],
                "parameters": [
                ...
                "responses": {
                    "200": {
                        "description": "an object that contains an array with all `file_links` related to a study\n",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "files": {
