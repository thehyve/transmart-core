var spec = {
  ...
  "paths": {
    ...
    "/v2/observations/aggregates_per_concept": {
      "get": {
        "description": "Calculates and returns an aggregates for both types of concepts, categorical and numerical. Deprecated. Use `aggregates_per_numerical_concept` or `aggregates_per_categorical_concept` calls instead.\n",
        "deprecated": true,
        "tags": [
          "v2"
        ],
    ...
    "/v2/observations/aggregates_per_numerical_concept": {
      "post": {
        "description": "Calculates and returns an aggregates numerical concepts.\n",
        "tags": [
          "v2"
        ],
        "requestBody": {
    ...
    "/v2/observations/aggregates_per_categorical_concept": {
      "post": {
        "description": "Calculates and returns an aggregates categorical concepts.\n",
        "tags": [
          "v2"
        ],
        "requestBody": {
    ...
    "/v2/export/jobs": {
      "get": {
        "description": "Gets all export jobs created by the user.\n",
        "tags": [
          "v2"
        ],
        "responses": {
    ...
    "/v2/admin/system/update_status": {
      "get": {
        "description": "Provides a status report about the current update task, started with `/v2/admin/system/after_data_loading_update`, or\nabout the latest completed task, if no task is currently running.\nOnly for administrators.\n",
        "tags": [
          "v2",
          "admin"
        ],
    ...
    "/v2/admin/system/config": {
      "get": {
        "description": "This endpoint serves the configuration options that can be changed during runtime.\nOnly for administrators.\n",
        "tags": [
          "v2",
          "admin"
        ],
