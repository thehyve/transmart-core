...
class RnaSeqTranscriptAnnotationStepsConfig implements StepBuildingConfigurationTrait {
    ...
    @Bean
    Step loadAnnotationMappings(ItemStreamReader<AnnotationEntity> rnaSeqTranscriptGatherAnnotationEntityIdsReader) {
        steps.get('loadAnnotationMappings')
                .allowStartIfComplete(true)
                .chunk(100)
                .reader(rnaSeqTranscriptGatherAnnotationEntityIdsReader)
    ...
    @Bean
    @JobScopeInterfaced
    GatherAnnotationEntityIdsReader rnaSeqTranscriptGatherAnnotationEntityIdsReader() {
