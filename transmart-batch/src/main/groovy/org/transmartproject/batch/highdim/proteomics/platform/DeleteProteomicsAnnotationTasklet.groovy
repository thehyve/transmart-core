...
/**
 * Removes data related to a specific proteomics platform from de_protein_annotation
 */
@Component
@JobScopeInterfaced
class DeleteProteomicsAnnotationTasklet implements Tasklet {
    ...
    RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        int i = jdbcTemplate.update("""
                DELETE FROM ${Tables.PROTEOMICS_ANNOTATION}
