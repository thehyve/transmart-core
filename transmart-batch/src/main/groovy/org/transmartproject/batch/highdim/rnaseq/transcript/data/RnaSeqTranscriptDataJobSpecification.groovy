...
/**
 * External parameters for RNASeq transcript data.
 */
@TypeChecked
class RnaSeqTranscriptDataJobSpecification implements JobSpecification {
    ...
    final Class<?> jobPath = RnaSeqTranscriptDataJobConfig
}
