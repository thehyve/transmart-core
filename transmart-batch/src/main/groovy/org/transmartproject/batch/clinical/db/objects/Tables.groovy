...
final class Tables {
    ...
    public static final String DIMENSION_DESCRIPTION    = 'i2b2metadata.dimension_description'
    public static final String STUDY_DIM_DESCRIPTIONS   = 'i2b2metadata.study_dimension_descriptions'
