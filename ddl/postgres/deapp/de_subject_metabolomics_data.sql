...
CREATE TABLE de_subject_metabolomics_data (
    ...
    metabolite_annotation_id bigint NOT NULL,
...
--
-- Name: de_subject_metabolomics_data_pk; Type: CONSTRAINT; Schema: deapp; Owner: -
--
ALTER TABLE ONLY de_subject_metabolomics_data
    ADD CONSTRAINT de_subject_metabolomics_data_pk PRIMARY KEY (assay_id, metabolite_annotation_id);
...
--
-- Name: de_subject_metabolomics_data_assay_id_fk; Type: FK CONSTRAINT; Schema: deapp; Owner: -
--
ALTER TABLE ONLY de_subject_metabolomics_data
    ADD CONSTRAINT de_subject_metabolomics_data_assay_id_fk FOREIGN KEY (assay_id) REFERENCES de_subject_sample_mapping(assay_id) ON DELETE CASCADE;
