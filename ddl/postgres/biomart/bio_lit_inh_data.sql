...
CREATE TABLE bio_lit_inh_data (
    ...
    bio_lit_ref_data_id bigint,	--NOT NULL DISABLE in oracle as a foreign key
...
--
-- Name: bio_lit_inh_data_pk; Type: CONSTRAINT; Schema: biomart; Owner: -
--
...
--
-- Name: trg_bio_lit_inh_data_id; Type: TRIGGER; Schema: biomart; Owner: -
--
...
--
-- Name: bio_lit_inh_ref_fk; Type: FK CONSTRAINT; Schema: biomart; Owner: -
--
ALTER TABLE ONLY bio_lit_inh_data
