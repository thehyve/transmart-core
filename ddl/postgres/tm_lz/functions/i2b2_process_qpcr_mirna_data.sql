--
-- Name: i2b2_process_qpcr_mirna_data(text, text, text, text, bigint, text, bigint, text, bigint); Type: FUNCTION; Schema: tm_lz; Owner: -
--
CREATE OR REPLACE FUNCTION i2b2_process_qpcr_mirna_data (
  trial_id 	character varying
 ,top_node	character varying
 ,mirna_type	character varying
