...
CREATE TABLE plugin_module (
    ...
    params text NOT NULL,	--oracle NOT NULL
    version character varying(10) DEFAULT 0.1 NOT NULL, --oracle NOT NULL
    active character(1) DEFAULT 'Y'::bpchar NOT NULL, --oracle NOT NULL
    has_form character(1) DEFAULT 'N'::bpchar NOT NULL, --oracle NOT NULL
