...
ALTER FUNCTION i2b2_load_chrom_region(character varying, numeric) SET search_path TO tm_cz, deapp;
...
ALTER FUNCTION i2b2_load_study_metadata(numeric) SET search_path TO tm_cz, tm_lz, deapp, biomart, pg_temp;
