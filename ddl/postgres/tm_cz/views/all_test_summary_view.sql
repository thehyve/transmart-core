...
--
CREATE OR REPLACE VIEW all_test_summary_view (test_run_id, test_run_name, start_date, end_date, status, test_category, test_sub_category1, test_sub_category2, pass, warning, fail, error, total, db_version) AS SELECT 
  a.test_run_id,
  a.test_run_name,
