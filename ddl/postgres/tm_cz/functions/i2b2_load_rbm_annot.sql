--
-- Name: i2b2_load_rbm_annot(); Type: FUNCTION; Schema: tm_cz; Owner: -
--
CREATE OR REPLACE FUNCTION i2b2_load_rbm_annotation (
...
BEGIN
	...
	,gene_id
        ...
        PERFORM d.gpl_id,p.antigen_id,d.antigen_name,trim(d.uniprotid) as uniprotid,d.gene_symbol,decode(d.gene_id,null,null,to_number(d.gene_id,'99999999999999999999D99999999999999999999')) as gene_id FROM (
	...
	(feature_group_name
	,feature_group_type)
	PERFORM distinct t.uniprotid, 'PROTEIN'
