...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_ARM_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "ARM", "ARM_NBR_OF_PATIENTS_STUDIED", "ARM_CLASSIFICATION_TYPE", "ARM_CLASSIFICATION_VALUE", "ARM_ASTHMA_DURATION", "ARM_GEOGRAPHIC_REGION", "ARM_AGE", "ARM_GENDER", "ARM_SMOKERS_PCT", "ARM_FORMER_SMOKERS_PCT", "ARM_NEVER_SMOKERS_PCT", "ARM_PACK_YEARS", "MINORITY_PARTICIPATION", "BASELINE_SYMPTOM_SCORE", "BASELINE_RESCUE_MEDICATION_USE") AS 
