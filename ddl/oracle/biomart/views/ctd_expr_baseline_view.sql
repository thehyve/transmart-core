...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_EXPR_BASELINE_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "BIOMOLECULE_NAME", "BASELINE_EXPR_PCT", "BASELINE_EXPR_NUMBER", "BASELINE_EXPR_VALUE_FOLD_MEAN", "BASELINE_EXPR_SD", "BASELINE_EXPR_SEM", "BASELINE_EXPR_UNIT") AS 
