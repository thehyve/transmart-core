...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_TREATMENT_PHASES_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "TRTMT_OCS", "TRTMT_ICS", "TRTMT_LABA", "TRTMT_LTRA", "TRTMT_CORTICOSTEROIDS", "TRTMT_ANTI_FIBROTICS", "TRTMT_IMMUNOSUPPRESSIVE", "TRTMT_CYTOTOXIC", "TRTMT_DESCRIPTION") AS 
