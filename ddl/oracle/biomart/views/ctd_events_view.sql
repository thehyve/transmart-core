...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_EVENTS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "DEFINITION_OF_THE_EVENT", "NUMBER_OF_EVENTS", "EVENT_RATE", "TIME_TO_EVENT", "EVENT_PCT_REDUCTION", "EVENT_P_VALUE", "EVENT_DESCRIPTION") AS 
