...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_CLINICAL_CHARS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "CLINICAL_VARIABLE", "CLINICAL_VARIABLE_PCT", "CLINICAL_VARIABLE_VALUE") AS 
