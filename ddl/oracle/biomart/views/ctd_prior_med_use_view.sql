...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_PRIOR_MED_USE_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "PRIOR_MED_DRUG_NAME", "PRIOR_MED_PCT", "PRIOR_MED_VALUE") AS 
