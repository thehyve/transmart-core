...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_EXPR_SOURCE_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "EXPR_CHG_SOURCE_TYPE", "EXPR_CHG_TECHNIQUE", "EXPR_CHG_DESCRIPTION") AS 
