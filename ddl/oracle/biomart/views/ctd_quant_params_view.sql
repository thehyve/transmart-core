...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_QUANT_PARAMS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "CLINICAL_VARIABLE_NAME", "PCT_CHANGE_FROM_BASELINE", "ABS_CHANGE_FROM_BASELINE", "RATE_OF_CHANGE_FROM_BASELINE", "AVERAGE_OVER_TREATMENT_PERIOD", "WITHIN_GROUP_CHANGES", "STAT_MEASURE_P_VALUE") AS 
