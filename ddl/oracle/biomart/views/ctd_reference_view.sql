...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_REFERENCE_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "REF_ARTICLE_PMID", "REF_PROTOCOL_ID", "REF_TITLE", "REF_RECORD_ID", "REF_BACK_REFERENCE") AS 
