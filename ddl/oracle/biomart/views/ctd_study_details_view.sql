...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_STUDY_DETAILS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "STUDY_TYPE", "COMMON_NAME", "ICD10", "MESH", "DISEASE_TYPE", "PHYSIOLOGY_NAME") AS 
