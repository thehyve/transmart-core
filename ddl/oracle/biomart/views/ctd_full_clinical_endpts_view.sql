...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_FULL_CLINICAL_ENDPTS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "PRIMARY_ENDPOINT_TYPE", "PRIMARY_ENDPOINT_DEFINITION", "PRIMARY_ENDPOINT_CHANGE", "PRIMARY_ENDPOINT_TIME_PERIOD", "PRIMARY_ENDPOINT_P_VALUE", "PRIMARY_ENDPOINT_STAT_TEST", "SECONDARY_TYPE", "SECONDARY_TYPE_DEFINITION", "SECONDARY_TYPE_CHANGE", "SECONDARY_TYPE_TIME_PERIOD", "SECONDARY_TYPE_P_VALUE", "SECONDARY_TYPE_STAT_TEST") AS 
