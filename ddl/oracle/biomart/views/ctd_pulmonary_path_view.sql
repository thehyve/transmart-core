...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_PULMONARY_PATH_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "PULMONARY_PATHOLOGY_NAME", "PULMPATH_PATIENT_PCT", "PULMPATH_VALUE_UNIT", "PULMPATH_METHOD") AS 
