...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_DRUG_EFFECTS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "DISCONTINUATION_RATE", "RESPONSE_RATE", "DOWNSTREAM_SIGNALING_EFFECTS", "BENEFICIAL_EFFECTS", "ADVERSE_EFFECTS", "PK_PD_PARAMETER", "PK_PD_VALUE", "EFFECT_DESCRIPTION") AS 
