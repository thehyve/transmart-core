...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_STATS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "CLINICAL_CORRELATION", "STATISTICAL_TEST", "STATISTICAL_COEFFICIENT_VALUE", "STATISTICAL_TEST_P_VALUE", "STATISTICAL_TEST_DESCRIPTION") AS 
