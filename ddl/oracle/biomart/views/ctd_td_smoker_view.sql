...
--
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_TD_SMOKER_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "TRIAL_SMOKERS_PCT", "TRIAL_FORMER_SMOKERS_PCT", "TRIAL_NEVER_SMOKERS_PCT", "TRIAL_PACK_YEARS") AS 
