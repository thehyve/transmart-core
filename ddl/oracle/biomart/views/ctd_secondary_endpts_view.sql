...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_SECONDARY_ENDPTS_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "SECONDARY_TYPE", "SECONDARY_TYPE_DEFINITION", "SECONDARY_TYPE_CHANGE", "SECONDARY_TYPE_TIME_PERIOD", "SECONDARY_TYPE_P_VALUE", "SECONDARY_TYPE_STAT_TEST") AS 
