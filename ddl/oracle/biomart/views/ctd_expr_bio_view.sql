...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_EXPR_BIO_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "BIOMOLECULE_NAME", "BIOMOLECULE_ID", "BIOMOLECULE_TYPE", "BIOMARKER", "BIOMARKER_TYPE") AS 
