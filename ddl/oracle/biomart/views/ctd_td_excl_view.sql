...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_TD_EXCL_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "EXCLUSION_CRITERIA1", "EXCLUSION_CRITERIA2", "MINIMAL_SYMPTOMS", "RESCUE_MEDICATION_USE", "CONTROL_DETAILS", "BLINDING_PROCEDURE", "NUMBER_OF_ARMS", "DESCRIPTION1", "DESCRIPTION2") AS 
