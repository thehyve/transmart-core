...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_EXPR_AFTER_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "BIOMOLECULE_NAME", "EXPR_AFTER_TRTMT_PCT", "EXPR_AFTER_TRTMT_NUMBER", "EXPR_AFTERTRTMT_VALUEFOLD_MEAN", "EXPR_AFTER_TRTMT_SD", "EXPR_AFTER_TRTMT_SEM", "EXPR_AFTER_TRTMT_UNIT") AS 
