...
--
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."CTD_TD_DESIGN_VIEW" ("ID", "REF_ARTICLE_PROTOCOL_ID", "NATURE_OF_TRIAL", "RANDOMIZATION", "BLINDED_TRIAL", "TRIAL_TYPE", "RUN_IN_PERIOD", "TREATMENT_PERIOD", "WASHOUT_PERIOD", "OPEN_LABEL_EXTENSION") AS 
