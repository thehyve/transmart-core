...
--
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."BIO_METAB_SUBPATHWAY_VIEW" ("SUBPATHWAY_ID", "ASSO_BIO_MARKER_ID", "CORREL_TYPE") AS 
 SELECT
               SP.id,
               B.bio_marker_id,
...
--
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "BIOMART"."BIO_METAB_SUPERPATHWAY_VIEW" ("SUPERPATHWAY_ID", "ASSO_BIO_MARKER_ID", "CORREL_TYPE") AS 
 SELECT
               SUPP.id,
               B.bio_marker_id,
