...
--
CREATE SEQUENCE  "DEAPP"."DE_PARENT_CD_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 3801 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--
...
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEAPP"."DE_PARENT_CD_TRG" 
