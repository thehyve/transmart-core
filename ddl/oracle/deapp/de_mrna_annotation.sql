...
"DE_MRNA_ANNOTATION_ID" NUMBER(22,0) NOT NULL ENABLE, 
 CONSTRAINT "DE_MRNA_ANNOTATION_PK" PRIMARY KEY ("DE_MRNA_ANNOTATION_ID")
 USING INDEX
...
--
CREATE SEQUENCE  "DEAPP"."SEQ_DE_MRNA_ANNOTATION_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 111121 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--
-- Type: TRIGGER; Owner: DEAPP; Name: TRG_DE_MRNA_ANNOTATION_ID
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEAPP"."TRG_DE_MRNA_ANNOTATION_ID" 
BEFORE INSERT ON deapp.de_mrna_annotation
FOR EACH ROW
BEGIN
