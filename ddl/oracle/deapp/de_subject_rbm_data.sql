...
"RBM_ANNOTATION_ID" NUMBER(*,0)
  ) SEGMENT CREATION DEFERRED
 TABLESPACE "DEAPP" ;

--
-- Type: REF_CONSTRAINT; Owner: DEAPP; Name: SYS_C0014934
--
ALTER TABLE "DEAPP"."DE_SUBJECT_RBM_DATA" ADD FOREIGN KEY ("RBM_ANNOTATION_ID")
 REFERENCES "DEAPP"."DE_RBM_ANNOTATION" ("ID") ENABLE;
