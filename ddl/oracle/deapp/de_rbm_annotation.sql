...
--
CREATE SEQUENCE  "DEAPP"."RBM_ANNOTATION_ID"  MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 12365 NOCACHE  NOORDER  NOCYCLE  NOPARTITION ;
--
-- Type: TRIGGER; Owner: DEAPP; Name: RBM_ID_TRIGGER
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEAPP"."RBM_ID_TRIGGER" 
