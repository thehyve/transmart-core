...
--
 CREATE TABLE "DEAPP"."DE_SNP_SUBJECT_SORTED_DEF" 
  (	"SNP_SUBJECT_SORTED_DEF_ID" NUMBER(22,0) NOT NULL ENABLE, --postgres NOT NULL
...
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEAPP"."TRG_SNP_SUBJECT_SORTED_DEF_ID" 
...
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEAPP"."TRG_DE_SUBJECT_SORTED_DEF_ID" 
before insert on DE_SNP_SUBJECT_SORTED_DEF
for each row
begin
if inserting then
