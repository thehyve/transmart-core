...
--
-- Type: REF_CONSTRAINT; Owner: DEAPP; Name: DE_VARIANT_POPULATION_INFO_FK
--
ALTER TABLE "DEAPP"."DE_VARIANT_POPULATION_INFO" ADD CONSTRAINT "DE_VARIANT_POPULATION_INFO_FK" FOREIGN KEY ("DATASET_ID")
