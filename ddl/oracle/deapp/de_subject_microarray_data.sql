...
--
 CREATE INDEX "DEAPP"."DE_MICROARRAY_DATA_IDX1" ON "DEAPP"."DE_SUBJECT_MICROARRAY_DATA" ("PROBESET_ID")
 TABLESPACE "INDX"  LOCAL
(PARTITION "NULL_PARTITION"
 TABLESPACE "INDX" ) COMPRESS 1 ;

--
-- Type: INDEX; Owner: DEAPP; Name: DE_MICROARRAY_DATA_IDX2
--
 CREATE INDEX "DEAPP"."DE_MICROARRAY_DATA_IDX2" ON "DEAPP"."DE_SUBJECT_MICROARRAY_DATA" ("ASSAY_ID")
 TABLESPACE "INDX"  LOCAL
(PARTITION "NULL_PARTITION"
 TABLESPACE "INDX" ) COMPRESS 1 ;
