...
CONSTRAINT "PLUGIN_MODULE_PK" PRIMARY KEY ("MODULE_SEQ")	        --postgres
CONSTRAINT "PLUGIN_MODULE_PLUGIN_FK1" FOREIGN KEY ("PLUGIN_SEQ") 	--postgres
	   REFERENCES "SEARCHAPP"."PLUGIN" ("PLUGIN_SEQ") ENABLE; 	--postgres
