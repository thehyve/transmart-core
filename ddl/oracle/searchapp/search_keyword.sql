...
--
 CREATE TABLE "SEARCHAPP"."SEARCH_KEYWORD" 
  (	"KEYWORD" NVARCHAR2(400), --postgres was (200)
"BIO_DATA_ID" NUMBER(18,0), 
"UNIQUE_ID" NVARCHAR2(500) NOT NULL ENABLE, 
"SEARCH_KEYWORD_ID" NUMBER(18,0) NOT NULL ENABLE, --postgres NOT NULL
...
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "SEARCHAPP"."TRG_SEARCH_KEYWORD_ID" before insert on "SEARCH_KEYWORD"    for each row begin     if inserting then       if :NEW."SEARCH_KEYWORD_ID" is null then          select SEQ_SEARCH_DATA_ID.nextval into :NEW."SEARCH_KEYWORD_ID" from dual;       end if;    end if; end;
