...
--
 CREATE TABLE "I2B2DEMODATA"."SET_UPLOAD_STATUS" 
  (	"UPLOAD_ID" NUMBER NOT NULL ENABLE, --postgres NOT NULL
"SET_TYPE_ID" NUMBER(38,0) NOT NULL ENABLE, --postgres NOT NULL
...
CONSTRAINT "PK_UP_UPSTATUS_IDSETTYPEID" PRIMARY KEY ("UPLOAD_ID", "SET_TYPE_ID") --postgres
