...
--
CREATE SEQUENCE  "I2B2DEMODATA"."SEQ_PATIENT_NUM"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1000117527 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--
...
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "I2B2DEMODATA"."TRIG_PATIENT_DIMENSION" 
