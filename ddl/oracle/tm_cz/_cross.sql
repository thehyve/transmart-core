...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TM_CZ"."CZV_PIVOT_SAMPLE_CATEGORIES" ("TRIAL_CD", "SAMPLE_CD", "TRIAL_NAME", "PATHOLOGY", "RACE", "TISSUE_TYPE", "GENDER", "BIOMARKER", "ACCESS_TYPE", "INSTITUTION", "PROGRAM_INITIATIVE", "ORGANISM", "COMPOUND", "PHASE") AS 
  select x.trial_cd
      ,x.sample_cd
	  ,x.trial_name
