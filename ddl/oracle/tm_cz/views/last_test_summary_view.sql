...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TM_CZ"."LAST_TEST_SUMMARY_VIEW" ("TEST_RUN_ID", "TEST_RUN_NAME", "START_DATE", "END_DATE", "STATUS", "TEST_CATEGORY", "TEST_SUB_CATEGORY1", "TEST_SUB_CATEGORY2", "PASS", "WARNING", "FAIL", "ERROR", "TOTAL", "DB_VERSION") AS 
  select
  a.test_run_id,
  a.test_run_name,
