...
--
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TM_CZ"."ALL_TEST_DETAIL_VIEW" ("RUN_ID", "TEST_ID", "RUN_NAME", "TABLE", "COLUMN", "CATEGORY", "SUB_CATEGORY1", "SUB_CATEGORY2", "SQL", "START_DATE", "END_DATE", "STATUS", "TEST_SEVERITY_CD", "ACT_RECORD_CNT", "MIN_VALUE_ALLOWED", "MAX_VALUE_ALLOWED", "ERROR_CODE", "ERROR_MESSAGE") AS 
  select
