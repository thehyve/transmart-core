...
--
CREATE SEQUENCE  "TM_CZ"."SEQ_CZ_JOB_AUDIT"  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 1544242 CACHE 2 NOORDER  NOCYCLE  NOPARTITION ;
--
-- Type: TRIGGER; Owner: TM_CZ; Name: TRG_CZ_SEQ_ID
--
  CREATE OR REPLACE EDITIONABLE TRIGGER "TM_CZ"."TRG_CZ_SEQ_ID" 
