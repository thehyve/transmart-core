--
-- Type: PROCEDURE; Owner: BIOMART_USER; Name: I2B2_METABOLOMICS_ZSCORE_CALC
--
  CREATE OR REPLACE EDITIONABLE PROCEDURE "BIOMART_USER"."I2B2_METABOLOMICS_ZSCORE_CALC" 
(
  trial_id VARCHAR2
 ,run_type varchar2 := 'L'
